        ...
        switch style.backgroundStyle.backgroundType {
            case .fullWidth:
                ...
                if safeAreaInset >= 54.0 {
                    value = 38.66 // For dynamic island devices, this ensures the navbar separator stays visible
                } else {
                    value = 44.0 // Default navbar height
                }
                return value + style.backgroundStyle.fullWidthStyle.height
            case .pill:
